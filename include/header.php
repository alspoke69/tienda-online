...
<header>
    ...
    <?php if(isset($_SESSION['login']) && $_SESSION['login'] == 'usuario') { ?>
        <a class="navbar-brand" href="index.php?uid=<?php echo $_GET['uid']; ?>">Tienda Zapatos</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item active">
              <a class="nav-link" href="index.php?uid=<?php echo $_GET['uid']; ?>">Inicio <span class="sr-only">(current)</span></a>
            </li>
            
            <li class="nav-item">
              <a class="nav-link" href="carrito.php?uid=<?php echo $_GET['uid']; ?>">Carrito</a>
            </li>
            <li class="nav-item">
          ...
          <ul class="navbar-nav">
            <li class="nav-item active">
              <a class="nav-link" href="index.php?uid=<?php  echo $_GET['uid']; ?>">Inicio <span class="sr-only">(current)</span></a>
                ...
                <li class="nav-item">
                <a class="nav-link" href="productos.php?uid=<?php echo $_GET['uid']; ?>">Agregar producto</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="cerrar_sesion.php">Cerrar sesión</a>
              </li>
